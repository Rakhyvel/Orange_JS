...
enum tokenType {
	// Enclosing tokens
    TOKEN_LPAREN, TOKEN_RPAREN, TOKEN_LSQUARE, TOKEN_RSQUARE, TOKEN_LBRACE,
	TOKEN_RBRACE,
	// Punctuation
	...
	// Branch operators
	TOKEN_IS, TOKEN_ISNT, TOKEN_GREATER, TOKEN_LESSER, TOKEN_GREATEREQUAL,
	TOKEN_LESSEREQUAL,
	// Boolean operators
	TOKEN_AND, TOKEN_OR,
	// Type operators
	...
	// Modifiers
	TOKEN_PRIVATE, TOKEN_STATIC, TOKEN_CONST, TOKEN_ARRAY,
	// Control flow structures
	TOKEN_IF, TOKEN_ELSE, TOKEN_WHILE, TOKEN_RETURN,
	// Anonymous tokens (added by parser)
